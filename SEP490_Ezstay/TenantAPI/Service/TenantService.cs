...
//     }
//
//     public IQueryable<TenantDto> GetAll()
//     {
...
//     {
//         var tenant =   _tenantRepository.GetAll().Where(x=> x.UserId == userId);
//         return tenant.ProjectTo<TenantDto>(_mapper.ConfigurationProvider);
//     }
//     public IQueryable<TenantDto> GetAllByRoomId(int roomId)
//     {
//         var tenant =   _tenantRepository.GetAll().Where(x=> x.RoomId == roomId);
//         return tenant.ProjectTo<TenantDto>(_mapper.ConfigurationProvider);
//     }
//
